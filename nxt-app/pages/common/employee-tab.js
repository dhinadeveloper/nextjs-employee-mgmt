...
export default function EmployeeTab() {
  ...
  React.useEffect(() => {
    setValue(router.asPath.slice(19) == "" ? "add" : router.asPath.slice(19));
      ...
      <TabContext value={value}>
        <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
          <TabList
            ...
            centered
          >
            <Tab label="Add" href="/employee/employee-add" value="add" />
            <Tab label="Edit" href="/employee/employee-edit" value="edit" />
            <Tab label="List" href="/employee/employee-list" value="list" />
          </TabList>
        </Box>
        {/* {props.children} */}
        <TabPanel value="add">
